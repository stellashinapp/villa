    ...
    <div className="min-h-screen flex items-center justify-center bg-bg px-4">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          <h1 className="text-2xl font-extrabold tracking-tight text-t1">ANDNEW</h1>
          <p className="text-xs text-t3 tracking-[2px] font-semibold mt-1">ADMIN CONSOLE</p>
        </div>
